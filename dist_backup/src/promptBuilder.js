...
`;
function buildSystemPrompt(persona = "generic", memoryContext = "Nenhuma memória relevante encontrada para esta sessão.") {
    const schemas = JSON.stringify(tools_1.ToolRegistry.getSchemas(), null, 2);
    const dynamicContext = (0, context_1.getDynamicContext)();
